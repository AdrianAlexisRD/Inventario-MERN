...
const Barra =({actualizar: modificar})=>{
  ...
  return(
      <div className={`${icon?'md:w-[50px] ':'md:w-[180px]'} barra shadow-[0_35px_35px_rgba(0,0,0,0.25)] z-20 Modo-Dark  mt-0 transition-all duration-500 ease-in-out `}>
          
        <button onClick={cambiar} className={`md:absolute right-0 color-primario hidden md:flex cursor-pointer`}>
          {icon?
          ...
          <button onClick={()=> setMostrarCont("main")}
              className={`${modificar ==='actualizar'? 'btn-barra ':'btn-barra md:mt-12 ' } ${icon?'md:w-[50px] ':'md:w-[180px]'} transition-all duration-500 ease-in-out hover:w-[180px] w-[50px] cursor-pointer`}>        
          ...
          {tipoAcceso === 'supervisor' &&
            ...
            className={`btn-barra ${icon?'md:w-[50px]  ':'md:w-[180px]'} transition-all duration-500 ease-in-out hover:w-[180px] w-[50px] cursor-pointer`}
          ...
          {tipoAcceso === 'supervisor' &&
            ...
            className={`btn-barra ${icon?'md:w-[50px] ':'md:w-[180px]'} cursor-pointer transition-all duration-500 ease-in-out hover:w-[180px] w-[50px] `}
