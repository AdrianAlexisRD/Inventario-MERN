...
const Header = ()=>{
    ...
    return (
        <header className='flex justify-around flex-wrap items-center dark:bg-[#030712] bg-[#e7e5ea] h-fit w-[100vw] sm:p-5 p-10 text-2xl flex-col sm:flex-row'> 
            <h1 className="flex gap-2 text-[30px] text-white items-center">
                <IconPackage className='dark:text-white color-primario' size={52} stroke={2} />
                <Link className='font-extrabold dark:text-white color-primario' to='/'>StockMaster</Link>
            </h1>
