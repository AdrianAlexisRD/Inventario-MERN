              ...
              <li key={index} className={
                ...
                shadow-2xs w-350 
                 ...
                 `} >
                    ...
                    <p className='flex items-center sm:justify-center text-[18px] font-bold'>{element.nota}</p>
                    <p className='flex items-center sm:justify-center text-[18px] font-bold'>{element.createdAt}</p>
                </li>
              ))}
        </ul>
    </div>
