...
<div className="justify-center dark:bg-[#3f384c] bg-white">
  ...
  <BgHome />
    <div className="flex flex-col md:flex-row md:gap-[50px] md:m-5 mt-10 items-center md:justify-center h-dvh  ">
      <div className="border-color dark:bg-[#121212] bg-white z-50 rounded-2xl p-3 mb-10 md:w-[50%] w-[90%]  ">
      <p className="md:text-3xl font-bold Modo-Dark rounded p-2  ">
        ...
        <ul className="flex flex-col justify-center gap-7 z-2 ml-8">
          <li className="style-li-home font-semibold "><IconPackage  size={48} stroke={2} /> Control de productos</li>
          <li className="style-li-home font-semibold "><IconReport size={48} stroke={2} /> Reportes actualizados</li>
          <li className="style-li-home font-semibold "><IconLock size={48} stroke={2} /> Acceso seguro y personalizado</li>
        </ul>
    </div>
